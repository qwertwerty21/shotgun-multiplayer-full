import {HOST_GAME_SERVER, JOIN_GAME_SERVER, JOIN_GAME_FAIL_SERVER, SET_CURRENT_PLAYER_SERVER, START_GAME_SERVER, SET_CURRENT_MOVE, 
    SEND_CURRENT_GAME_STATE_SERVER, SHOW_ROUND_RESULTS_SERVER, RESET_NEXT_ROUND_CURRENT_PLAYER_SERVER, START_NEXT_ROUND_SERVER, ALERT_LEAVER_SERVER} from '../constants/constants';
...
export default function( state=INITIAL_STATE, action ){
    ...
    switch(action.type){
        ...
        case SEND_CURRENT_GAME_STATE_SERVER: 
            console.log('GOT SEND_CURRENT_GAME_STATE_SERVER IN GAME REDUCER', action.payload)
            return Object.assign({}, state, {
                currentPlayer: {
