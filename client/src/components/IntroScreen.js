		...
		if( Object.keys(emptyFields).length > 0){
			...
			for(let keys in emptyFields){
				if( emptyFields.hasOwnProperty(keys) ){
					...
					newState[errField] = 'Enter your Name before Hosting or Joining a Game.'
				}
			...
			<div className='intro__container'>
				<div className='row'>
					<div className="col-md-6 col-md-offset-3">
						<h1 className='text-center header__title'>
                            Shotgun Multiplayer
                        </h1>
						...
						<List className='mainscreenbtns__container' >
							...
							<ListItem>
								<TextField
									...
									inputStyle={{'color': '#fff', 'text-shadow': '1px 1px #000', 'font-size': '24'}}
