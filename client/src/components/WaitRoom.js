        ...
        <div className="row">
          <div className="col-md-6 col-md-offset-3 text-center">
            ...
            <h2 className="waitroom__header">
              Game Room ID: <br />
              <span className="header__room-id">{this.props.game.room.id}</span>
            </h2>
            <h3 className="players-list__header">Players Joined:</h3>
            ...
            {this.props.currentPlayer.host ? (
              ...
              <div className="waitroom__waiting-text">
                Waiting for {this.props.game.room.host.name} (Host) to Start the
                Game...
              </div>
            )}
          </div>
